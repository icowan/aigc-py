...
class Assistants(Base):
    ...
    name = Column(String, index=True, unique=True, comment="名称")
    avatar = Column(String, nullable=True, comment="头像")
    remark = Column(String, nullable=True, comment="描述")
    model_name = Column(String, index=True, comment="模型名称")
    description = Column(String, nullable=True, comment="助手描述")
    instructions = Column(String, nullable=True, comment="助手使用说明")
    metadata_origin = Column(String, name="metadata", nullable=True, comment="助手元数据")
...
class Tools(Base):
    ...
    type = Column(String, index=True, comment="工具类型")
    metadata_origin = Column(String, name="metadata", nullable=False, comment="工具元数据")
    operator = Column(String, nullable=False, comment="操作人")
